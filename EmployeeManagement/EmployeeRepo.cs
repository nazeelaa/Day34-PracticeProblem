...
namespace EmployeeMangement
{
    ...
    {
        public static string connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Employees1;Integrated Security=True";
        ...
        public bool AddEmployee(EmployeeModel model)
        {
            try
            {
                ...
                {
                    SqlCommand command = new SqlCommand("SpAddEmployee3", this.connection);
        ...
        public void GetAllEmployee()
        {
            try
            {
                ...
                using (this.connection)
                {
                    string query = @"Select EmployeeName,PhoneNumber,Address,Department,Gender,BasicPay,Deductions,TaxablePay,Tax,NetPay,StartDate,City,Country from Employee_Details";
